  ...
  return (
    <Layout>
      <main className="mt-8 mb-16 container">
        ...
        <div className="text-justify flex flex-col gap-2 my-10 max-w-5xl mx-auto">
          <p className="text-left">
            Our Autonomous Testing Bot revolutionizes the testing process for
            your application.
          </p>
          <p>
            ...
            application. The generated tests can be prioritized, allowing for
            seamless regression testing.
          </p>
          <p>
            Unlike traditional testing methods, there's no need for manual test
            case preparation or coding. The entire testing process is automated,
            making it a hassle-free experience for you. Learning programming
          ...
          <p>
            ...
            changes, you receive a report highlighting the modifications that
            need assessment. For bug reporting, we follow standard procedures.
            For new application versions, a simple one-click updates the
            application testing model.
          </p>
          <p>
            The validation process for the application under test relies heavily
            on visual examination. In addition to the visual inspection, we
            meticulously gather data on various aspects such as HTTP status
            codes, JavaScript errors, and the speed at which the application
            loads. These comprehensive quality metrics serve as crucial
            indicators, allowing us to identify and address potential issues
            with the application under test.
          </p>
        </div>

        <div className="flex flex-col md:flex-row justify-center gap-10 my-10 xl:my-16">
          {cmdPictures.map((picture) => (
            <div>
              <img
        ...
        <div className="text-justify flex flex-col gap-2 my-10 max-w-5xl mx-auto">
          <h4 className="text-2xl text-secondary-wopee dark:text-primary-wopee">
            Benefits:
          </h4>
          <ul>
            <li>
            ...
            <li>No need for programming skills or record-and-play tools.</li>
            <li>Seamless regression testing with prioritized tests.</li>
            <li>
              Simplified maintenance with automatic reporting of application
              changes.
            </li>
          </ul>
        </div>

        <div className="text-justify flex flex-col gap-2 mt-10 max-w-5xl mx-auto">
          <h3 className="text-2xl text-secondary-wopee dark:text-primary-wopee">
