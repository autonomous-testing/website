    ...
    >
      <div className="flex flex-col w-1/2 gap-4 items-center">
        <section className="text-center text-white">
          <h2 className="text-xl sm:text-3xl">Self-Driving Bot</h2>
          <h3 className="font-normal text-lg sm:text-xl text-primary-wopee">
            Only URL required
          </h3>
          <h3 className="font-normal text-xs sm:text-sm">
...
const VisualTestingCard = () => {
  ...
  return (
    <div
      ...
      className="flex items-center justify-around w-[355px] sm:w-[530px] xl:w-[600px] h-[195px] py-4 rounded-lg border hover:ring-2 hover:ring-secondary-wopee border-solid border-secondary-wopee bg-gradient-to-br from-primary-wopee to-white overflow-hidden hover:cursor-pointer transition-shadow ease-in-out"
    >
      <div className="flex flex-col w-1/2 gap-4 items-center">
        <section className="text-center text-black">
          <h2 className="text-xl sm:text-3xl">Visual Testing</h2>
      ...
      <div className="w-1/4 h-full">
        <figure className="relative h-full w-[500px]">
          <img
            className="absolute -rotate-12 opacity-50 -translate-x-[70px] sm:-translate-x-[90px] -translate-y-[70px] inset-0"
