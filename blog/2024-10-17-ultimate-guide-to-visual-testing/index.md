...
To help organizations innovate their testing practices, Wopee.io runs [pilot projects](https://wopee.io/pilot/): 8 weeks, run as 8 weekly sprints, covering up to 10 critical user flows of one web application. Our engineers build the first tests and your team builds around 20 more with our coaching, so the suite keeps working once the pilot ends. That asks 3 to 5 person-days per sprint of your team, roughly 20 to 35 person-days in total. A baseline is measured in Sprint 1 and compared against it in Sprint 8, where a named decision maker makes a go or no-go call. Alongside visual testing, the same pilot can cover AI-driven functional coverage of the agreed flows.
