...
const TLDR_ROWS = [
  {
    aspect: "Pricing",
    left: "No published prices on any tier; paid tiers show 'Custom / Talk to us', subscriptions sized in proprietary 'Test Units'",
...
const FAQS: CompareFaqItem[] = [
  {
    ...
    answer:
      "Applitools does not publish prices. As of August 2026, no tier on its pricing page shows a number: Public Cloud and Dedicated Cloud say 'Custom / Talk to us', and Starter offers only a free trial, with subscriptions sized in proprietary Test Units. Wopee.io publishes its pricing: start free, then 19 to 179 € per user per month.",
    render: (
      <>
        Applitools does not publish prices. As of August 2026, no tier on its
        pricing page shows a number: Public Cloud and Dedicated Cloud say
        'Custom / Talk to us', and Starter offers only a free trial, with
        subscriptions sized in proprietary Test Units. Wopee.io publishes its pricing:{" "}
        <Link href="/pricing/">
    ...
    <section className="w-full flex flex-col items-center py-16 px-4">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400 mb-4">
          Open both pricing pages side by side. Applitools publishes no numbers:
          Public Cloud and Dedicated Cloud show 'Custom / Talk to us', Starter
          offers only a free trial, and subscriptions are sized in 'Test
          Units', a metric only Applitools can calculate. Its own pricing FAQ includes 'Is Applitools expensive?'
        </p>
...
const WopeeVsApplitools = () => {
  ...
  return (
    ...
    >
      ...
      <LastChecked note="Last checked: August 2026. Applitools details come from applitools.com public pages, including its platform-pricing and Autonomous product pages." />
