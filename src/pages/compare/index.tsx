...
import { COMPARISONS } from "@site/src/components/compare-page/comparisons";
...
const CompareHub = () => {
  ...
  return (
    ...
    >
      ...
      <LastChecked note="Last checked: August 2026. Competitor details come from their public pages and archived snapshots." />
