...
description: "Combine Robot Framework with Wopee.io for autonomous visual testing. Practical guide to adding visual regression to existing RF test suites."
authors: marcel
