...
const FAQS: CompareFaqItem[] = [
  {
    ...
    answer:
      "No. Octomind discontinued its AI testing product in May 2026, and the octomind.dev website is offline as of August 2026. In its farewell letter, the team said it did not find the market validation needed to keep going.",
  },
  {
    question: "Is octomind.run the same product?",
    answer:
      "No. octomind.run is an unrelated open-source agent runtime by a different company that reuses the name. The Octomind AI testing product lived at octomind.dev, was discontinued in May 2026, and its domain no longer resolves.",
  },
  {
